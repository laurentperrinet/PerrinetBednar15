...
\newcommand{\Conference}{CerCo's 20$^{th}$ anniversary, Toulouse, France.}%
\newcommand{\Date}{Friday 5th July, 2013}%
%%%%%%%%%%% faizi laTETE %%%%%%%%%%%%%%%
...
\subtitle{\SubTitle}%
\institute{\small{$1$ - \Address \\ $2$ - \AddressBis \\ $3$ - \AddressB \\ $4$ - \AddressC}}%
\date{\Date\   \\ %\Website \\ 
...
\only<3|handout:2>{%
	\includegraphics[width=\linewidth]{../ms/figure2.png}%
}%
\only<4|handout:0>{%
	\includegraphics[width=.468\linewidth]{testing_short_chevrons_serre07_distractors.png}&%
	\includegraphics[width=.468\linewidth]{classifier_chevrons_laboratory.png}\\%
}%
Natural &%
Laboratory %
\end{tabular}%
